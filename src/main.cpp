...
int main (int argc, char *argv[]) {
	...
	for(int i = 0; i < qtdOperacoes; i++) {
		...
		if(entrada == "u") {
			...
			std::cin >> entrada;
			unsigned long int a00 = std::stoi(entrada);
			std::cin >> entrada;
			unsigned long int a01 = std::stoi(entrada);
			std::cin >> entrada;
			unsigned long int a10 = std::stoi(entrada);
			std::cin >> entrada;
			unsigned long int a11 = std::stoi(entrada);
			...
			std::cin >> entrada;
			unsigned long int x = std::stoi(entrada);
			std::cin >> entrada;
			unsigned long int y = std::stoi(entrada);
			Vetor* vetor = new Vetor(x, y);
			jogo.consulta(nascimento, morte, vetor);
			std::cout << vetor->getX() % 100000000L << " " << vetor->getY() % 100000000L << "\n";
			delete vetor;
		}
	}
}
